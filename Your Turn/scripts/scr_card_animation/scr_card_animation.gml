...
function card_animation(target_x, target_y, spd){
	...
	// distância
	var xdist = target_x - xstart
	var ydist = target_y - ystart
	var dist = point_distance(xstart, ystart, target_x, target_y);
